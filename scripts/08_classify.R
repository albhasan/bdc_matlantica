...
project_dir   <- "/home/alber-d006/Documents/bdc_matlantica"
out_dir <- paste0(project_dir, "/results/", classification_name)
cube_name <- paste0("matlantica_LC8_30_16D_STK-1")
model_file    <- paste0("/home/alber-d006/Documents/bdc_matlantica/results/",
                        classification_name,
                        "/ml_model.rds")
